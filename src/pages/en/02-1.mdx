...
<Row>
    <Figure mode="in:row-3" src="/img/02-1/Untitled.png">Drought caused out-of-control fires in Australia in 2019, which have killed more than half a billion animals</Figure>
    <Figure mode="in:row-3" src="/img/02-1/Untitled 1.png">July 2021: Zhengzhou City, Henan Province, China, experienced heavy rains; the water on the road was almost flooded to the chest</Figure>
    <Figure mode="in:row-3" src="/img/02-1/Untitled 2.png">December 2021: South Korea's "coldest winter" hit a 41-year low, snowstorms in various places</Figure>
</Row>
...
<Row>
    ...
    <Figure mode="in:row" src="/img/02-1/Untitled 3.png">Exhaust emissions cause increased carbon dioxide concentration</Figure>

</Row>

<Row>
    <Figure mode="in:row" classList="order-last md:order-first" src="/img/02-1/Untitled 4.png">Deforestation of the Brazilian Amazon</Figure>
    <div>
        ### Changes in land use
...
<Row>
    ...
    <Figure mode="in:row" src="/img/02-1/Untitled 5.png">Overuse of plastic containers</Figure>
</Row>
...
<Row>
    <Figure mode="in:row-3" src="/img/02-1/Untitled 6.png">Water pollution</Figure>
    <Figure mode="in:row-3" src="/img/02-1/Untitled 7.png">This Chinese ship collided with the Iranian tanker and the oil spill spread to 130 square kilometers</Figure>
    <Figure mode="in:row-3" src="/img/02-1/Untitled 8.png">Water pollution from industrial and domestic wastewater streams</Figure>
</Row>
...
<Row>
    <Figure mode="in:row-3" src="/img/02-1/Untitled 9.png">Burning fossil fuels not only emits pollutants in the air, but also releases a lot of carbon dioxide</Figure>
    <Figure mode="in:row-3" src="/img/02-1/Untitled 10.png">Air pollution caused by exhaust emissions from cars</Figure>
</Row>
...
<Row>
    ...
    <Figure mode="in:row" src="/img/02-1/Untitled 11.png">Hazardous industrial waste dug up from a depth of 6 meters underground</Figure>
</Row>
...
<Row>
    ...
    <Figure mode="in:row" classList="order-last md:order-first" src="/img/02-1/Untitled 12.png"></Figure>
</Row>
...
<Row>
    ...
    <Figure mode="in:row" src="/img/02-1/Untitled 13.png"></Figure>
</Row>