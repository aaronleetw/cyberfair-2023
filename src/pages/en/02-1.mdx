...
<Row>
    <Figure mode="in:row-3" img={import("../../assets/img/02-1/Untitled.png")}>Drought caused out-of-control fires in Australia in 2019, which have killed more than half a billion animals</Figure>
    <Figure mode="in:row-3" img={import("../../assets/img/02-1/Untitled 1.png")}>July 2021: Zhengzhou City, Henan Province, China, experienced heavy rains; the water on the road was almost flooded to the chest</Figure>
    <Figure mode="in:row-3" img={import("../../assets/img/02-1/Untitled 2.png")}>December 2021: South Korea's "coldest winter" hit a 41-year low, snowstorms in various places</Figure>
</Row>
...
<Row>
    <Figure mode="in:row-3" img={import("../../assets/img/02-1/Untitled 6.png")}>Water pollution</Figure>
    <Figure mode="in:row-3" img={import("../../assets/img/02-1/Untitled 7.png")}>This Chinese ship collided with the Iranian tanker and the oil spill spread to 130 square kilometers</Figure>
    <Figure mode="in:row-3" img={import("../../assets/img/02-1/Untitled 8.png")}>Water pollution from industrial and domestic wastewater streams</Figure>
</Row>
...
<Row>
    <Figure mode="in:row-3" img={import("../../assets/img/02-1/Untitled 9.png")}>Burning fossil fuels not only emits pollutants in the air, but also releases a lot of carbon dioxide</Figure>
    <Figure mode="in:row-3" img={import("../../assets/img/02-1/Untitled 10.png")}>Air pollution caused by exhaust emissions from cars</Figure>
</Row>
