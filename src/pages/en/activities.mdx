...
<Row classList={['']}>
    <Figure classList={['lg:m-0 mr-2']} img={import('../../assets/img/activities/beach/01.jpg')} quality="1" />
    <Figure classList={['lg:m-0 mr-2']} img={import('../../assets/img/activities/beach/02.jpg')} quality="1" />
    <Figure classList={['lg:m-0 mr-2']} img={import('../../assets/img/activities/beach/03.jpg')} quality="1" />
