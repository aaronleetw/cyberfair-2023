...
<Figure mode="float-right" classList="lg:w-1/3" img={import("../../assets/img/03/01.png")} imageFit="inside"></Figure>
...
<Figure mode="float-left" classList="lg:w-2/5" img={import("../../assets/img/03/02.png")} imageFit="inside">Figure 2: Fisheries economy in Taiwan </Figure>
