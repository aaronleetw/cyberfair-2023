...
title: "Positive Ecological and Economic Impacts"
bg: "/img/cover/008-.jpg"
---
import Figure from '@components/Figure.astro';
import Row from '@components/Row.astro';


<Figure mode="float-right" src="/img/03/01.png" imageFit="inside"></Figure>
...
<Figure mode="float-right" src="/img/03/02.png" imageFit="inside">Figure 2: Fisheries economy in Taiwan </Figure>
