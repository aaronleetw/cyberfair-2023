...
<Row classList="mb-3">
    <Figure mode="in:row-3" src="/img/06/Untitled.png">Store Appearance</Figure>
    <Figure mode="in:row-3" src="/img/06/Untitled 1.png">Self-made Containers</Figure>
    <Figure mode="in:row-3" src="/img/06/Untitled 2.png">Side-View of the Store</Figure>
</Row>
...
<Row classList="mb-3">
    <Figure mode="in:row-3" src="/img/06/Untitled 3.png">InBlooom Store</Figure>
    <Figure mode="in:row-3" src="/img/06/Untitled 4.png">The Three Founders of InBlooom</Figure>
    <Figure mode="in:row-3" src="/img/06/Untitled 5.png">InBlooom Products</Figure>
</Row>
...
<Row classList="mb-3">
    <Figure mode="in:row-3" src="/img/06/Untitled 6.png">Unpackaged.U Store</Figure>
    <Figure mode="in:row-3" src="/img/06/Untitled 7.png">Daily Food Supplies and Needs</Figure>
    <Figure mode="in:row-3" src="/img/06/Untitled 8.png">Founder of Unpackaged.U</Figure>
</Row>
...
<Row classList="mb-3">
    <Figure mode="in:row-3" src="/img/06/Untitled 9.png">Sustainable Food Supplies in Store</Figure>
    <Figure mode="in:row-3" src="/img/06/Untitled 10.png">Decorations Outside the Store</Figure>
    <Figure mode="in:row-3" src="/img/06/Untitled 11.png">Products Inside</Figure>
</Row>
