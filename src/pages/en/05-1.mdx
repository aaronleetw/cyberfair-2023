...
<Row>
    ...
    <Figure mode="in:row" classList="order-last lg:order-first" img={import("../../assets/img/05-1/Untitled 1.png")} alt=""></Figure>
</Row>
...
<Row classList="mb-3">
    <Figure mode="in:row-3" img={import("../../assets/img/05-1/Untitled 2.png")} alt="">The rapid increase in fossil fuels is the result of the dramatic increase in Taiwan's electricity consumption</Figure>
    <Figure mode="in:row-3" img={import("../../assets/img/05-1/Untitled 3.png")} alt=""></Figure>
</Row>
