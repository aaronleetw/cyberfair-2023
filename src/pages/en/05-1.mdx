...
<Row>
    ...
    <Figure mode="in:row" classList="!mt-0" src="/img/05-1/Untitled.png" alt=""></Figure>
</Row>
<Row>
    <div>
    ...
    <Figure mode="in:row" classList="order-last lg:order-first" src="/img/05-1/Untitled 1.png" alt=""></Figure>
</Row>
...
<Row classList="mb-3">
    <Figure mode="in:row-3" src="/img/05-1/Untitled 2.png" alt="">The rapid increase in fossil fuels is the result of the dramatic increase in Taiwan's electricity consumption</Figure>
    <Figure mode="in:row-3" src="/img/05-1/Untitled 3.png" alt=""></Figure>
</Row>
...
<Row>
    ...
    <Figure mode="in:row" src="/img/05-1/Untitled 4.png" alt="">The Beitou Library</Figure>
</Row>
...
<Figure mode="center" src="/img/05-1/Untitled 5.png" alt="" highQuality="2" imageFit="inside"></Figure>
