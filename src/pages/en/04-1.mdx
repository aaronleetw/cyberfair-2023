...
<Row>
    <Figure mode="in:row-3" img={import("../../assets/img/04-1/Untitled.png")}></Figure>
    <Figure mode="in:row-3" img={import("../../assets/img/04-1/Untitled 1.png")} imageFit="inside"></Figure>
</Row>
...
<Row>
    <Figure mode="in:row-3" img={import("../../assets/img/04-1/Untitled 3.png")} imageFit="inside">Taiwan weather in the Summer</Figure>
    <Figure mode="in:row-3" img={import("../../assets/img/04-1/Untitled 4.png")} imageFit="inside">Taiwan weather in the Winter</Figure>
</Row>
...
<Row>
    <Figure mode="in:row-3" img={import("../../assets/img/04-1/Untitled 6.png")}></Figure>
    <Figure mode="in:row-3" img={import("../../assets/img/04-1/Untitled 7.png")}></Figure>
</Row>
