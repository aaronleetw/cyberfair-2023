...
<Row>
    <Figure mode="in:row-3" img={import("../../assets/img/02-3/Untitled 4.png")}>Gogoro's Emphasis on Sustainable Driving</Figure>
    <Figure mode="in:row-3" img={import("../../assets/img/02-3/Untitled 5.png")}>Nike's Sustainable Materials For Their Shoes</Figure>
</Row>
<p></p>