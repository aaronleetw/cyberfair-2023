...
<Figure mode="center" imageFit="inside" src="/img/02-3/Untitled.png" highQuality="1">Food Insecurity Trend Graph 2014 - 2021</Figure>
<Figure mode="center" imageFit="inside" src="/img/02-3/Untitled 1.png" highQuality="1">Trends In Global Captures 1950 - 2020</Figure>
<Figure mode="center" imageFit="inside" src="/img/02-3/Untitled 2.png" highQuality="1">World Capture Fisheries and Aquaculture Production 1950 - 2020</Figure>

<Figure mode="float-right" imageFit="inside" src="/img/02-3/Untitled 3.png" highQuality="1">Potential Net Benefit from Coral Reefs</Figure>
...
<Row>
    <Figure mode="in:row-3" src="/img/02-3/Untitled 4.png">Gogoro's Emphasis on Sustainable Driving</Figure>
    <Figure mode="in:row-3" src="/img/02-3/Untitled 5.png">Nike's Sustainable Materials For Their Shoes</Figure>
</Row>
<p></p>