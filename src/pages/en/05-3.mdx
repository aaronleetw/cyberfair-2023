...
<Row>
    ...
    <Figure mode="in:row" src="/img/05-3/25_3000_0.jpg" imageFit="inside"></Figure>
</Row>
...
<Row>
    ...
    <Figure mode="in:row" src="/img/05-3/0_fhUP1sS6AEC6sVN6.png" imageFit="inside" highQuality="0.5">Greta Thunberg's Twitter post about her speech of the UN plenary at COP24</Figure>
</Row>
...
<Row>
    ...
    <Figure mode="in:row" classList="order-last md:order-first" src="/img/05-3/554181852-origin.jpg" imageFit="inside"></Figure>
</Row>
...
<Row classList="mb-3">
    <Figure mode="in:row-3" src="/img/05-3/ScreenGrab07.jpg"></Figure>
    <Figure mode="in:row-3" src="/img/05-3/download.jpeg"></Figure>
</Row>
