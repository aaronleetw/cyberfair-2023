...
<Row>
    ...
    <Figure mode="in:row" src="/img/05-4/bioplastic-biodegradable-plastic.webp">People can use environmentally friendly products at home such as biodegradable plastic</Figure>
</Row>
...
<Row classList="mb-3">
    ...
    <Figure mode="in:row" classList="order-last md:order-first" src="/img/05-4/download_(1).jpeg">Ebooks can be used to replace printed documents</Figure>
</Row>
...
<Row>
    ...
    <Figure mode="in:row" src="/img/05-4/1024x768_attractions-image-pajdr7p5jkyrn3_utff_pw.jpg">Taipei Beitou Library</Figure>
</Row>
...
<Row>
    ...
    <Figure mode="in:row" classList="order-last md:order-first" src="/img/05-4/zero-waste-sustainability.jpg">Eco-friendly shops like this one sell products that do not leave a large carbon footprint</Figure>
</Row>
...
<Row>
    ...
    <Figure mode="in:row" src="/img/05-4/formosan-aboriginal-culture-village-ropeway.webp">People must evaluate environmental impacts when building facilities like this amusement park</Figure>
</Row>
