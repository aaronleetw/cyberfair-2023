...
<Figure mode="float-left" classList="lg:w-1/3" imageFit="inside" img={import("../../assets/img/02-2/Untitled 1.png")}>Coral bleaching causes many economic losses to various industries such as tourism, fisheries and biodiversity. (estimated value is shown)</Figure>
