...
<Figure mode="float-right" src="/img/02-2/Untitled.png">Butterfly fish listed as endangered species due to coral bleaching</Figure>
...
<Figure mode="float-left" imageFit="inside" src="/img/02-2/Untitled 1.png">Coral bleaching causes many economic losses to various industries such as tourism, fisheries and biodiversity. (estimated value is shown)</Figure>
...
<Figure mode="center" src="/img/02-2/Untitled 2.png">Comparison between healthy coral reefs and corals after bleaching</Figure>
