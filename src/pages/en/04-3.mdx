...
<Figure mode="float-right" src="/img/04-3/Untitled.png" alt="">Hengchun Fringing reefs</Figure>
...
<Figure mode="float-left" src="/img/04-3/Untitled 1.png" alt="">Coral bleaching in Taiwan</Figure>
