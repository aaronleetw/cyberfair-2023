...
title: "Home"
bg: "/assets/img/cover/01.webp"
---

import Figure from '@components/Figure.astro';
import Row from '@components/Row.astro';

<Figure mode="float-right" classList="!mt-0" img={import("../assets/img/index/C46E74EC-0659-4213-A7C6-A7CBADC739EC.jpeg")}>Figure 1: Polar bear's tongue stuck in a food can</Figure>
...
<Row>
    <Figure mode="in:row" img={import("../assets/img/index/Untitled.png")}>Figure 2: Hurricane's on Belgium's streets</Figure>
    <Figure mode="in:row" img={import("../assets/img/index/Untitled 1.png")}>Figure 3: Drought in South Africa due to climate change</Figure>
    <Figure mode="in:row" img={import("../assets/img/index/01.jpg")}>Figure 4: Wildfire in California due to warmer, drier conditions</Figure>
</Row>