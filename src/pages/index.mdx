...
<Figure mode="float-right" img={import("../assets/img/index/C46E74EC-0659-4213-A7C6-A7CBADC739EC.jpeg")}>Figure 1: Polar bear's tongue stuck in a food can</Figure>
...
<Row>
    <Figure mode="in:row-3" img={import("../assets/img/index/Untitled.png")}>Figure 2: Hurricane's on Belgium's streets</Figure>
    <Figure mode="in:row-3" img={import("../assets/img/index/Untitled 1.png")}>Figure 3: Drought in South Africa due to climate change</Figure>
    <Figure mode="in:row-3" img="https://via.placeholder.com/600x420">Figure 4: This is a placeholder</Figure>
</Row>