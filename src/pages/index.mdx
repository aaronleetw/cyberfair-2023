...
<Row>
    <Figure mode="in:row-3" src="/img/index/Untitled.png">Figure 2: Hurricane's on Belgium's streets</Figure>
    <Figure mode="in:row-3" src="/img/index/Untitled%201.png">Figure 3: Drought in South Africa due to climate change</Figure>
    <Figure mode="in:row-3" src="https://via.placeholder.com/600x420">Figure 4: This is a placeholder</Figure>
</Row>