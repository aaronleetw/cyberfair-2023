...
<Figure mode="float-right" classList="lg:w-1/5 w-1/2" src="/img/tai-coral/Untitled.png"></Figure>
...
<Row>
    ...
    <Figure mode="in:row" src="/img/tai-coral/Untitled 1.png">Image 2: North East Coast Coral communities</Figure>
</Row>
...
<Row>
    ...
    <Figure classList="md:w-1/3  md:order-first" mode="in:row" src="/img/tai-coral/Untitled 2.png">Image 3: Platygyra daedalea (brain coral)</Figure>
</Row>
...
<Row>
    ...
    <Figure classList="md:w-[110%]" mode="in:row" src="/img/tai-coral/Untitled 3.png">Image 4: Fringing Reef in the Hengchun Peninsula</Figure>
</Row>
...
<Row>
    ...
    <Figure classList="md:w-2/3" mode="in:row" src="/img/tai-coral/Untitled 4.png">Image 5: Lanyu Fringing Reef Topography</Figure>
</Row>
...
<Row>
    ...
    <Figure classList="md:w-full" mode="in:row" src="/img/tai-coral/Untitled 5.png">Image 6: Coral bleaching in the Penghu Islands</Figure>
</Row>
